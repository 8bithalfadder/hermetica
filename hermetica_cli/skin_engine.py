...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Hermetica"          # Banner title, status display
...
.. code-block:: python
    ...
    from hermetica_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#FFD700"
    print(skin.get_branding("agent_name"))  # "Hermetica"
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        ...
        "branding": {
            "agent_name": "Hermetica",
            "welcome": "Welcome to Hermetica! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",

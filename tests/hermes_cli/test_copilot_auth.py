...
class TestTokenValidation:
    ...
    def test_is_classic_pat(self):
        from hermetica_cli.copilot_auth import is_classic_pat
...
class TestResolveToken:
    ...
    def test_copilot_github_token_first_priority(self, monkeypatch):
        from hermetica_cli.copilot_auth import resolve_copilot_token
...
class TestApiModeSelection:
    ...
    def test_gpt5_uses_responses(self):
        from hermetica_cli.models import _should_use_copilot_responses_api
